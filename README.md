About epics-medm-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/epics-medm-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15534&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epics-medm-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15534&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epics-medm-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_64</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15534&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epics-medm-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `epics-medm` can be installed with `conda`:
...
```
mamba install epics-medm
```

It is possible to list all of the versions of `epics-medm` available on your platform with `conda`:
...
```
mamba search epics-medm --channel conda-forge
```
...
mamba repoquery search epics-medm --channel conda-forge

# List packages depending on `epics-medm`:
mamba repoquery whoneeds epics-medm --channel conda-forge

# List dependencies of `epics-medm`:
mamba repoquery depends epics-medm --channel conda-forge
```
